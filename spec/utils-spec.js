describe("Utils", function() {
	...
	it("polar origin ", function() {
            var r = 0, t = 0;
            expect(~~(polar_to_cartesian(r,t)[0])).toEqual(0);
            expect(~~(polar_to_cartesian(r,t)[1])).toEqual(0);
	});

	it("polar to cartesian 1,90", function() {
            var r = 1, t = 90;
            expect(~~(polar_to_cartesian(r,t)[0])).toEqual(0);
            expect(~~(polar_to_cartesian(r,t)[1])).toEqual(1);
        });
	...
	it("polar to cartesian 20,90", function() {
            ...
            var t = 90;
            expect(~~(polar_to_cartesian(r,t)[0])).toEqual(0);
            expect(~~(polar_to_cartesian(r,t)[1])).toEqual(r);
	});

	it("polar to cartesian 20, 180", function() {
            var r = 20, t = 180;
            expect(~~(polar_to_cartesian(r,t)[0])).toEqual(-20);
            expect(~~(polar_to_cartesian(r,t)[1])).toEqual(0);
	});
	...
	it("polar to cartesian, 20, 270", function() {
            var r = 20, t = 270;
            expect(~~(polar_to_cartesian(r,t)[0])).toEqual(0);
            expect(~~(polar_to_cartesian(r,t)[1])).toEqual(-20);
	});
